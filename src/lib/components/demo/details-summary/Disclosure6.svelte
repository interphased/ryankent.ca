<script lang="ts">
	...
	onMount(() => {
		const swapInnerHtmlWithResponse = (el: HTMLElement) =>
			fetch(el.dataset.href as string)
...
<details>
	...
	<article data-intersect-json data-href="/api/demo/details-summary.json">Loading...</article>
</details>
